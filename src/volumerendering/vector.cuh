...
__device__ __host__ const float3 saturate(const float3 v);
//__device__ const float3 saturate(const float3 v);
__device__ __host__ const float3 max_float3(const float3 a, const float3 b);
__device__ __host__ const float3 min_float3(const float3 a, const float3 b);
